...
# DREAM-CS-Fast B-version full UFD run.
# bank_plus_anchor gives a pure conditional anchor; anchor_only experts use base_ctx + residual.
...
MODEL_NAME=${MODEL_NAME:-dream_cs_fast_bank_plus_anchor_anchoronlycond_ufd_full_seed100}
